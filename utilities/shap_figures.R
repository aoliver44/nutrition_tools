...
tryCatch( { if (length(levels(as.factor(input$label))) == 2) {
  ...
  ggplot2::ggsave(plot = importance_plot_full, filename = paste0(opt$outdir, "importance_plot_full_1.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_full$X)))), 6), height = 4.5, units = "in")
  ...
  importance_plot_full <- shapviz::sv_importance(sv_full, kind = "bee", show_numbers = TRUE, bee_width = 0.2, max_display = 10, show_other = FALSE) + 
    ggtitle(label = paste0("SHAP: ", opt$label, " (full data)")) + theme_bw(base_size = 14)
  ggplot2::ggsave(plot = importance_plot_full, filename = paste0(opt$outdir, "importance_plot_full_2.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_full$X)))), 6), height = 4.5, units = "in")
  ...
  ggplot2::ggsave(plot = importance_plot_train_1, filename = paste0(opt$outdir, "importance_plot_train_1.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_train$X)))), 6), height = 4.5, units = "in")
  ...
  ggplot2::ggsave(plot = importance_plot_train_2, filename = paste0(opt$outdir, "importance_plot_train_2.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_train$X)))), 6), height = 4.5, units = "in")
  ...
  ggplot2::ggsave(plot = importance_plot_test_1, filename = paste0(opt$outdir, "importance_plot_test_1.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_test$X)))), 6), height = 4.5, units = "in")
  ...
  ggplot2::ggsave(plot = importance_plot_test_2, filename = paste0(opt$outdir, "importance_plot_test_2.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_test$X)))), 6), height = 4.5, units = "in")
  ...
  if (opt$type == "regression") {
    ...
    ggplot2::ggsave(plot = importance_plot_train, filename = paste0(opt$outdir, "importance_plot_train.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_train$X)))), 6), height = 4.5, units = "in")
    ...
    importance_plot_test <- shapviz::sv_importance(sv_test, kind = "bee", show_numbers = TRUE, bee_width = 0.2, max_display = 10, show_other = FALSE) + 
      ggtitle(label = paste0("SHAP: ", opt$label, " (train)")) + theme_bw(base_size = 14)
    ggplot2::ggsave(plot = importance_plot_test, filename = paste0(opt$outdir, "importance_plot_test.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_test$X)))), 6), height = 4.5, units = "in")
    ...
    importance_plot_full <- shapviz::sv_importance(sv_full, kind = "bee", show_numbers = TRUE, bee_width = 0.2, max_display = 10, show_other = FALSE) + 
      ggtitle(label = paste0("SHAP: ", opt$label, " (full data)")) + theme_bw(base_size = 14)
    ggplot2::ggsave(plot = importance_plot_full, filename = paste0(opt$outdir, "importance_plot_full.pdf"), width = pmin((0.1 * max(nchar(colnames(sv_full$X)))), 6), height = 4.5, units = "in")
